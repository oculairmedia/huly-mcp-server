...
export const definition = {
  ...
  description:
    'Generate comprehensive, detailed impact analysis and preview reports for proposed deletion operations across various entity types, providing exhaustive dependency mapping, affected entity enumeration, and cascading effect visualization to enable informed decision-making and risk assessment before executing irreversible deletion operations. This advanced analytical tool conducts deep organizational analysis to identify all entities, relationships, and workflows that would be affected by deletion operations, including direct dependencies, indirect relationships, cascading effects, and potential organizational disruptions. The preview process includes configurable cascade analysis for hierarchical structures, detailed entity enumeration with comprehensive metadata, stakeholder impact assessment, and intelligent recommendation generation for alternative approaches or mitigation strategies. Advanced features include multi-level dependency traversal for complex organizational structures, detailed reporting with entity-specific impact descriptions, configurable detail levels for different analysis depths, and comprehensive visualization of affected relationships and workflows. The tool supports complex organizational scenarios requiring thorough change impact analysis, risk assessment, and stakeholder communication while providing clear, actionable insights for safe organizational change management. This tool is essential for administrative planning, risk management, organizational restructuring, and maintenance scenarios requiring comprehensive, reliable, and auditable deletion impact analysis with full consideration for complex organizational dependencies, stakeholder impacts, and operational continuity requirements across diverse project types and organizational structures.',
  inputSchema: {
    type: 'object',
    properties: {
      entity_type: {
